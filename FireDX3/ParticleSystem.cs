...
namespace FireDX3
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public long countParticles()
        {
            return (particles.Length/4);
        }
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                foreach (EffectPass pass in particleEffect.CurrentTechnique.Passes)
                {
                    ...
                    else
                    {
                        ...
                        device.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, firstActiveParticle * 4, (settings.MaxParticles - firstActiveParticle) * 4, firstActiveParticle * 6, (settings.MaxParticles - firstActiveParticle) * 2);
